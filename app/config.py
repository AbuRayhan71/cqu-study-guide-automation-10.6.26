...
class Settings:
    ...
    google_api_base: str = os.getenv("GOOGLE_API_BASE", "https://generativelanguage.googleapis.com/v1beta")
    google_timeout_seconds: int = int(os.getenv("GOOGLE_TIMEOUT_SECONDS", "180"))
